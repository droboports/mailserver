...
Check the [releases](https://github.com/droboports/mailserver/releases) page. If there are no releases available, then you have to compile.
...
```
git clone https://github.com/droboports/mailserver.git
cd mailserver
./build.sh
ls -la *.tgz
```
...
* GCC atomic: https://gcc.gnu.org/git/?p=gcc.git
